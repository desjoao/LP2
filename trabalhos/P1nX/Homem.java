...
public class Homem extends Pessoa{
	...
	public Homem(String genero ,String nome, String sobrenome, int dia, int mes, int ano, String CPF, float peso, float altura){
		super(nome, sobrenome, dia, mes, ano, CPF, peso, altura);
		setGenero(genero);				
	}
	public Homem(String genero, String nome, String sobrenome, String dia, String mes, String ano, String CPF, float peso, float altura){
		super(nome, sobrenome, dia, mes, ano, CPF, peso, altura);
		setGenero(genero);
	}
